...
from myapp.views import ProductListView, Login, Logout, Register,AdminProductListView,AdminLoginView,CreateProductAdmin,UpdateProductAdmin,RefundProductAdmin
